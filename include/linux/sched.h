...
struct user_struct {
	 ...
	 *
	 */
	long user_divisor;	/* needed to determine current user */
...
/* task state */
	 ...
	 *
	 *
	 * Change made by Sonu Varma
	 *
	 */
	static inline _syscall0(int, sys_myincreaseshare)
...
/* journalling filesystem info */
	 ...
	 *
	 */
	unsigned int multiplier /* needed for multiplying process share */
};
